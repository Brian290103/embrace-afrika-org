...
import { deleteSponsor } from "@/actions/sponsorsAction"; // Updated import
...
const DeleteConfirmationDialog: React.FC<DeleteDialogProps> = ({
  ...
  const handleDeleteAction = async () => {
    ...
    try {
      await deleteSponsor(id); // Updated action call
      toast.success(`${name} deleted successfully`);
    } catch (error: any) {
      toast.error(error.message || "Failed to delete sponsor"); // Updated error message
    } finally {
